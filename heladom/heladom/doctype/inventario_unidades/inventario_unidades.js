...
frappe.ui.form.on('Inventario Unidades', {
...
frappe.ui.form.on('Inventario Unidades Items', {
	sku: function(frm, cdt, cdn) {
		var row = locals[cdt][cdn];
		frappe.call({
			"method": "heladom.heladom.doctype.inventario_unidades.inventario_unidades.get_sku_info",
			args: {
				"sku": row.sku
			},
